...
String FirmwareVer = "28-10-2024 Ver1";
...
void CANBUSTASK_INVERTER_CODE( void * pvParameters ) {
  ...
  for (;;) {
    ...
    TemperatureRule = SystemTemp < INVTempLim;  // IF MAX TEMP, CUT CURRENT
    ...
    CalculatedChargeCurrent = MaxCurrent * ChargePercentage * MaxSystemVoltageRule * 0.01 * MaxSOCRule * TemperatureRule * CellVoltageRule;
    CalculatedDischargeCurrent = MaxCurrent * DischargePercentage * 100 * 0.01 * MinSOCRule * TemperatureRule;


    if (String1MaxCellModbus < 4.7  && String1MinCellModbus < 4.7 && String1MaxCellModbus > 1.8  && String1MinCellModbus > 1.8) {
    ...
    if (SerialBT.available()) {
      ...
      if (param_start2 != -1 && param_end2 != -1) {
        ...
        SerialBT.println("TemperatureRule:" + String(TemperatureRule) +
                         ...
                         "/SOCOverlookValue:" + String(SOCOverlook) +
